...
# user_X = pd.DataFrame({'usuario': usuario, 'phishing_recibido': emails_phishing_recibidos, 'phishing_clicado': emails_phishing_clicados})
...
# print(clf.predict([user_X_train.values.ravel()]))
